...
function naked_register_sidebars() {
	register_sidebar(array(				// Start a series of sidebars to register
		...
		'before_widget' => '<aside class="mdl-cell"><div class="mdl-card dgl-card">',	// What to display before each widget
		'after_widget' => '</div></aside>',	// What to display following each widget
